...
<div class="row">
    <div class="col-md-12">
        <ul class="nav nav-tabs" id="musicTab" role="tablist">
            <li class="nav-item">
                <a class="nav-link active" id="plays-tab" data-toggle="tab" href="#plays" role="tab" aria-selected="true">
                    <i class="fas fa-clock"></i> Plays
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" id="tracks-tab" data-toggle="tab" href="#tracks" role="tab" aria-selected="false">
                    <i class="fas fa-music"></i> Tracks
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" id="artists-tab" data-toggle="tab" href="#artists" role="tab" aria-selected="false">
                    <i class="fas fa-star"></i> Artists
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" id="albums-tab" data-toggle="tab" href="#albums" role="tab" aria-selected="false">
